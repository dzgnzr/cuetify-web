...
function App() {
  ...
  // ─────────────────────────────
  // AUTOSAVE ACTIVE SCRIPT
  // ─────────────────────────────

  useEffect(() => {
    if (!activeScriptId || !scriptsLoaded) {
      return;
    }
        ...
        <main className="mx-auto max-w-5xl px-8 pb-20 pt-14">
          ...
          <div className="flex items-end justify-between gap-8">
            ...
            <div>
              ...
              <p className="mb-3 text-sm font-medium text-[#7A7771]">
                TELEPROMPTER
              </p>
              ...
              <p className="mt-6 max-w-lg text-base leading-7 text-[#77736D]">
            ...
            <button
              ...
              className="shrink-0 rounded-xl bg-[#242321] px-6 py-3 text-sm font-semibold text-white transition hover:opacity-85"
            >
              + New Script
            </button>
  ...
  return (
    ...
    >
      ...
      <div
        className={`absolute left-5 right-5 top-5 z-30 flex items-center justify-between transition-opacity duration-500 ${
          showControls
            ? "opacity-100"
      ...
      >
        ...
        <button
          ...
          className={`rounded-full px-4 py-2 text-sm backdrop-blur ${
            theme === "light"
        ...
        <div
          className={`rounded-full px-4 py-2 text-xs backdrop-blur ${
            theme === "light"
      ...
      <div
        className={`absolute bottom-6 left-0 right-0 z-30 flex justify-center transition-all duration-500 ${
          showControls
      ...
      >
        ...
        <div
          className={`flex max-w-[95vw] items-center gap-2 overflow-x-auto rounded-full border px-4 py-3 shadow-2xl backdrop-blur-xl ${
            theme === "light"
        ...
        >
          ...
          <button
            ...
            className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full hover:bg-current/10"
          >
            {isPlaying
              ? "Ⅱ"
              : "▶"}
          ...
          <div className="mx-1 h-5 w-px shrink-0 bg-current/10" />
          ...
          <span className="w-9 shrink-0 text-center text-xs opacity-70">
            {speed.toFixed(1)}×
          </span>
          ...
          <button
            ...
            className="shrink-0 rounded-lg px-2 py-1.5 text-xs opacity-60 hover:bg-current/10 hover:opacity-100"
          >
            A−
          </button>

          <span className="w-8 shrink-0 text-center text-xs opacity-60">
            {fontSize}
          </span>
          ...
          <select
            ...
            className={`rounded-lg border-none px-3 py-1.5 text-xs outline-none ${
              theme === "light"
                ? "bg-black/5"
                : "bg-white/10"
            }`}
          ...
          <button
            ...
            className="rounded-lg px-3 py-1.5 text-xs opacity-70 hover:bg-current/10"
          >
            {alignment === "center"
              ? "Center"
              : "Left"}
          ...
          <select
            ...
            className={`rounded-lg border-none px-2 py-1.5 text-xs outline-none ${
              theme === "light"
                ? "bg-black/5"
                : "bg-white/10"
            }`}
